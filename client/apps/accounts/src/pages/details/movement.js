...
class TFGAccountsMovement extends Component {
  ...
  _renderIcon() {
    if (this.movement.type === 1) {
      return this
        .html`<mwc-icon class="movement__icon movement__icon--up">trending_up</mwc-icon>`;
    }
    return this
      .html`<mwc-icon class="movement__icon movement__icon--down">trending_down</mwc-icon>`;
  }
  render() {
